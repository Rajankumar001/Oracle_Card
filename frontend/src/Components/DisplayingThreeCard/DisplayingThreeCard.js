...
const DisplayThreeCard = () => {
  ...
  useEffect(() => {
    const storedData = localStorage.getItem('threeCards');
    if (storedData) {
...
export default DisplayThreeCard;
